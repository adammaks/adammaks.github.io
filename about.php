...
<div class="container">
	...
	<!-- content about -->
		<div class="about">
			<div class="logo-about"><div class="block-black-page"></div>
				<p class="name-about">Мы умеем делать качественно, мы лучшее что вы видели,одевали и чувствовали.</p>
			</div>
			<div class="about-story">
				<div class="about-story-left">
					<img src="/images/images-page/about/1-about.jpg" class="img-about-one" title="looka me"/>
					<img src="/images/images-page/about/2-about.jpg" class="img-about-two" title="looka me"/>
				</div>
				<div class="about-story-right">
					<p class="name-text-about-one">Наша история</p>
					<p class="name-text-about-two">О нашем магазине</p>
					<p class="name-text-about-there">
						Привет , семья! Да , да , именно семья! Ведь покупая наш товар , мы становимся одной большой семьей , которая развивает бренд Look’a Me.
						Наш проект зародился как экспиремент , но вы доказали нам обратное, что это далеко не эксперимент , а реально нужный пазл в вашей жизни.
					</p>
					<p class="name-text-about-there">
						Пазл который дополняет вас и дает уверенность в каждом дне - выбирая наш бренд. Мы хотим помочь вам стать более индивидуальными , модными и конечно-же самыми интересными.
					</p>
					<p class="name-text-about-there">
						Мы делаем для вас только лучшее , самый качественный товар , в котором удобно как в повседневном ритме , так и любых случаях жизни.
						С каждой новой коллекцией мы будем учитывать ваши предложения и совершенствоваться для вас. Ведь благодаря вам мы развиваемся как бренд - Look`a Me.
					</p>
				</div>
			</div>
			<div class="quote">
				<p class="quote-text">
					«Вы должны иметь стиль. Он помогает спускаться по лестнице. Он помогает подняться по утрам. Это образ жизни. Без него вы – ничто. И сейчас я говорю не о количестве одежды».
						<br/>
						© Диана Вриланд
				</p>
			</div>
			<div class="about-story about-story2">
				<div class="about-story-right">
					<p class="name-text-about-one">Наши цели</p>
					<p class="name-text-about-two">О наших целях и планах на будущее</p>
					<p class="name-text-about-there">
						Привет , семья! Да , да , именно семья! Ведь покупая наш товар , мы становимся одной большой семьей , которая развивает бренд Look’a Me.
						Наш проект зародился как экспиремент , но вы доказали нам обратное, что это далеко не эксперимент , а реально нужный пазл в вашей жизни.
					</p>
				...
				<div class="about-story-left">
					<img src="/images/images-page/about/3-about.jpg" class="img-about-one2" title="looka me"/>
					<img src="/images/images-page/about/4-about.jpg" class="img-about-two2" title="looka me"/>
				</div>
			</div>
		</div>
	<!-- end content about -->
