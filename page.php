...
<div class="container">
	...
	<!-- content about -->
		<div class="page-open">
			<div class="logo-page-open"><div class="block-black-page"></div>
				<p class="name-about">Открытие оффлайн мгазина</p>
			</div>
			<div class="about-page-open">
				<div class="photo-page">
					<img src="/images/images-page/pages/1-open-offline.jpg" title="looka me"/>
				</div>
				<div class="block-text-page">
					<p class="name-text-page-open-one">Скоро открытие</p>
					<p class="name-text-page-open-two">Look`a Me - оффлайн магазин</p>
					<p class="name-text-page-open-there">
