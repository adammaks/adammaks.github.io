...
<div class="container">
	...
	<!-- 404 -->
	<div class="error">
		<p class="error-name">Ошибка 404</p>
		<p class="error-text">Вероятнее всего ссылка устарела или была не правильной - такой страницы не существует!</p>
		<p class="error-text">Рекомендуем перейти на <a href="index.php" class="error-url">главную</a> страницу сайта</p>
	</div>	
	<!-- end 404 -->
	...
	<div class="foter-card-copy">
		<p class="copyrighting">© 2020 All rights reserved. Designed by adam_maks.</p>
		<nav class="nav-link">
			<ul>
